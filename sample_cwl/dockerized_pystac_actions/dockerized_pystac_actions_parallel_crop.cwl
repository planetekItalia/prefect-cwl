...
$graph:
  ...
  - class: Workflow
    ...
    outputs:
      ...
      output_cropper_two:
        type: Directory
        outputSource: cropper_two/cropper_output
      output_cropper_three:
        type: Directory
        outputSource: cropper_three/cropper_output
    steps:
      downloader:
        run: "#downloader"
        in:
      ...
      cropper_two:
        ...
        in:
          cropper_input: downloader/downloader_output
          downloader_bbox_two: downloader_bbox_two
        out: [cropper_output]
      cropper_three:
        run: "#cropper_three"
        in:
          cropper_input: downloader/downloader_output
          downloader_bbox_three: downloader_bbox_three
        out: [ cropper_output ]
